...
struct strat_t_any_cloaked_wraiths : strat_mod {
...
//				build_n(starport, 2);
//			}
//			if (enemy_anti_air_army_supply <= wraith_count * 2 || wraith_count <= enemy_air_army_supply / 1.5) {
//				build(wraith);
//			}

//			//if (wraith_count >= 4 || (enemy_anti_air_army_supply > wraith_count * 2 && wraith_count > enemy_air_army_supply / 1.5)) {
//			if (wraith_count >= 4) {
//				build(siege_tank_tank_mode);
//				upgrade(siege_mode);
//			}
...
//			if (players::opponent_player->race == race_zerg) {
//				if (ground_army_supply > enemy_anti_air_army_supply * 2) {
//					if (wraith_count >= 2 || enemy_air_army_supply) {
//						build(valkyrie);
//					}
//				}
//			}
//			if (wraith_count + tank_count + vulture_count >= 5 && army_supply > enemy_army_supply) {
//				build_n(cc, 2);
//			}
...
//			if (players::opponent_player->race == race_zerg && scv_count >= 24 && wraith_count >= 2) {
//				if (enemy_hydralisk_count / 4 + enemy_lurker_count) build_n(siege_tank_tank_mode, 4);
//				else build_n(siege_tank_tank_mode, 2);
//				upgrade(siege_mode) && upgrade_wait(spider_mines) && upgrade_wait(ion_thrusters);
//			}
//			if (vulture_count < enemy_ground_small_army_supply / 2) {
//				if (vulture_count) {
//					maxprod(vulture);
